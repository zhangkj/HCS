    ...
    public class UserInfoService:IUserInfoService
    {
        ...
        public DataSet GetUserInfo(UserInfo UserInfo)
        {
            ...
            SqlParameter[] asqlpara = new SqlParameter[] {
                        new SqlParameter("@vchrUserId", System.Data.SqlDbType.VarChar),
                        new SqlParameter("@vchrUserPassword", System.Data.SqlDbType.VarChar)
            };
            asqlpara[0].Value = UserInfo.UserName;
            asqlpara[1].Value = UserInfo.UserPassword;
            ds = RunProcedure("HCS_GetUserInfo", asqlpara, "UserInfo");
            return ds;
        }
