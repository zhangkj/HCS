...
namespace HCS
{
    public partial class ItemUnitInfoEdit : Form
    {
        public ItemUnitInfoEdit()
        {
            InitializeComponent();
        }
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            sbaseinfo.InfoType = 4;//infotype 1为科室信息类型
