...
namespace HCS
{
    public partial class ItemStandardinfoEdit : Form
    {
        public ItemStandardinfoEdit()
        {
            InitializeComponent();
        }
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            sbaseinfo.InfoType = 3;//infotype 3为规格信息类型
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sbaseinfo.Id = Convert.ToInt32(txtId.Text);
                sbaseinfo.Name = txtName.Text;
                sbaseinfo.InfoType = 3;//infotype 1为科室信息类型
        ...
        private void ItemStandardEdit_Load(object sender, EventArgs e)
        {
