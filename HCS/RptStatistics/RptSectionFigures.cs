...
namespace HCS
{
    public partial class RptSectionFigures : Form
    {
        public RptSectionFigures()
        {
            InitializeComponent();
        ...
        private void btnSelectRpt_Click(object sender, EventArgs e)
        {
            if (rdbByDay.Checked || rdbByMonth.Checked || rdbByYear.Checked)
            {
                ...
                {
                    strArray[0] = "1";
                    strRptFileName = "RptSectionFigureByDay.rpt";
                }
                else if (rdbByMonth.Checked)
                {
                    strArray[0] = "2";
                    strRptFileName = "RptSectionFigureByMonth.rpt";
                }
                else if (rdbByYear.Checked)
                {
                    strArray[0] = "3";
                    strRptFileName = "RptSectionFigureByYear.rpt";
                }
                DataSet ds = new DataSet();
                ds = RptManager.GetRpt("HCS_GetRptSectionFigure", strArray);
